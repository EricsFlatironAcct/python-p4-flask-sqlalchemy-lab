...
def animal_by_id(id):
    ...
    if not animal:
        return not_found_response_builder('Animal')
...
def zookeeper_by_id(id):
    ...
    if not zookeeper:
        return not_found_response_builder('Zookeeper')
...
def enclosure_by_id(id):
    ...
    if not enclosure:
        return not_found_response_builder('Enclosure')
...
def not_found_response_builder(self, route_name):
    response_body = f'<h1>404 {route_name} not found'
